package com.thedreamsanctuary.main.java.dreamplus.effect;

import com.thedreamsanctuary.main.java.dreamplus.effect.ReflectionHandler.PackageType;
import com.thedreamsanctuary.main.java.dreamplus.effect.ReflectionHandler.PacketType;
import com.thedreamsanctuary.main.java.dreamplus.effect.ReflectionHandler.SubPackageType;
...
public enum ParticleEffect {
	 ...
	 * @param offsetZ Maximum distance particles can fly away from the center on the z-axis
	 * @param speed Display speed of the particles
	 * @param amount Amount of particles@IllegalArgumentException if the range is higher than 20
	 * @see #sendPacket
	 * @see #instantiatePacket
	 */
